...
function [popnew, bestmemnew, bestvalnew, tracerst, ccm, used_FEs] = sansde(fname, func_num, dim_index, pop,subcost1, bestmem, bestval, Lbound, Ubound, itermax, ccm, gcount);
    ...
    val = feval(fname, gpop, subcost1, func_num);
    [best, ibest] = min(val);
    subbestmem = pop(ibest, :);
    subbestmem = subbestmem;
    ...
    while iter < itermax
        ...
        gpop(:, dim_index) = ui;
        tempval = feval(fname, gpop, subcost1, func_num);
